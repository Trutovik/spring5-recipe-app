package com.sabal.spring5recipeapp.bootstrap;

import com.sabal.spring5recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    if (!unitOfMeasureRepository.findAll().iterator().hasNext()) {
      ...
      UnitOfMeasure pint = UnitOfMeasure.builder().description("Pint").build();
      unitOfMeasureRepository.save(pint);
      UnitOfMeasure dash = UnitOfMeasure.builder().description("Dash").build();
      ...
      Category italian = Category.builder().description("Italian").build();
      categoryRepository.save(italian);
      Category fastFood = Category.builder().description("Fast Food").build();
      ...
      tacosRecipe.setUrl("www.pornhub.com");
